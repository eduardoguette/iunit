...
if (document.querySelector(".prsri")) {
  ...
  btnQuitForm.addEventListener("click", function (e) {
    ...
    setTimeout(() => {
      document.querySelector("#container-form").classList.add("is-hidden");
    }, 1);
  });
  ...
  btn_info.addEventListener("click", function (e) {
    ...
    document.querySelector(".container-form").classList.remove("is-hidden");
  });
